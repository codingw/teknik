<title>Memcache CMS video liputan6</title>
<div style="background-color:orange;height:100px;">
	<center>
		<br><h2> Get Key Memcache CMS Video Liputan6</h2>	
	</center>
</div>
...
Server : <?=$server?>
<br />
<a href="memcached_cms_videoliputan6.php?id=">
...
?>
 <br /><br /><br />
<form action="memcached_cms_videoliputan6.php" method="get" name="memcached">
